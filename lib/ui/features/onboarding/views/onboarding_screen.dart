                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(page.title, style: const TextStyle(fontFamily: 'Plus Jakarta Sans', fontSize: 34, fontWeight: FontWeight.w700, color: AppTheme.onSurface, height: 1.15, letterSpacing: -0.5), textAlign: TextAlign.center),
                          const SizedBox(height: AppTheme.spaceXl),
                          Text(page.subtitle, style: const TextStyle(fontFamily: 'Plus Jakarta Sans', fontSize: 16, fontWeight: FontWeight.w400, color: AppTheme.onSurfaceVariant, height: 1.6), textAlign: TextAlign.center),
                        ],
                      ),
                    ),
                  );
